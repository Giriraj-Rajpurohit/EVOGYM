        ...
        <motion.div onViewportEnter={() => setSelectedPage(SelectedPage.ContactUs)}>
            ...
            <div className='justify-between gap-8 md:flex mt-10'>
                ...
                >
                    ...
                    target='_blank'
                    onSubmit={onSubmit}
                    action='https://formsubmit.co/girirajpurohit13@gmail.com'
                    method='POST'
                    >
                        ...
                        {errors.name && (
                            <p className='mt-1 text-primary-500'>
                                {errors.name.type === 'required' && "This field in required."}
                                {errors.name.type === 'maxLength' && "Max length is of 100 charachters."}
                            </p>
                        )}
                        ...
                        {errors.email && (
                            <p className='mt-1 text-primary-500'>
                                {errors.email.type === 'required' && "This field in required."}
                        ...
                        {errors.message && (
                            <p className='mt-1 text-primary-500'>
                                {errors.message.type === 'required' && "This field in required."}
                                {errors.message.type === 'maxLength' && "Max length is of 2000 charachters."}
                            </p>
                        )}
